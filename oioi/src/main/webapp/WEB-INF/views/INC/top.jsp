					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar shopping" >
								<a href="ChatList" onclick="window.open(this.href, '_blank', 'width=400, height=600, left=760, top=300, resizable=no'); return false;" class="single-icon" >
								...
								<div class="shopping-item">
									...
									<div class="bottom">
										...
										<a href="ChatList" onclick="window.open(this.href, '_blank', 'width=400, height=600, left=760, top=300, resizable=no'); return false;" class="btn animate">채팅 더보기</a>
									</div>
								</div>
								<!--/ End Shopping Item -->
							</div>
