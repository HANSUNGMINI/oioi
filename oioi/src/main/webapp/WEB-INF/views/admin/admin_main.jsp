                            ...
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-md-6"> <!-- USERS LIST -->
                                    <div class="card">
                                        ...
                                        <div class="card-footer text-center"> <a href="javascript:" class="link-primary link-offset-2 link-underline-opacity-25 `-underline-opacity-100-hover">View All Users</a> </div> <!-- /.card-footer -->
                                    </div> <!-- /.card -->
                                </div> <!-- /.col -->
